...
const testimonials: Testimonial[] = [
  {
    id: 1,
    name: 'Stiliyan Zlatanov',
    role: 'Собственик',
    company: 'къша София',
    rating: 5,
    text: 'Доволен съм от услугата. Изкопът и отводнителната система бяха направени бързо и качествено.Препоръчвам!.',
    project: 'Изкоп за басейн',
    date: '15.11.2024',
  },
  {
    id: 2,
    ...
    company:"Къща София",
    rating: 5,
    text: 'Работата с екипа беше истинско удоволствие, изключително бърза реакция и бързо начало на работния процес. Още от самото начало разбраха точно какво трябва да се направи, въпреки че в нашия случай казусът беше по-необичаен.Ставаше въпрос за изхвърляне на смесени отпадъци и подреждане на останали вещи в двора, а крайният резултат беше фантастичен. В рамките на един ден свършиха работа, която иначе можеше да се проточи във времето.',
    date: '12.01.2026',
  },
  {
    id: 3,
    ...
    company: 'Къща',
    rating: 5,
    text: 'Използвахме D&D Construction за изкопни услуги в с. Петково, област София. Работиха с мини багер и направиха изкоп за тесни основи на ограда. Реагираха бързо, спазиха срока и работиха много прецизно, пазейки нашата собственост. Препоръчвам ги за изкопни работи с малък багер в София и района.Препоръчвам!.',
    project: 'Къща - с.Петково',
    date: '10.03.2026',
  },
  {
    id: 4,
