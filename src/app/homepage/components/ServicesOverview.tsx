...
{
  id: 6,
  title: 'ВиК услуги – изграждане на водопровод и канализация',
  description: 'Изграждане на водопроводни и канализационни връзки, разкопаване при аварии и възстановяване на терена.',
  icon: 'WrenchIcon',
  image: "/assets/images/20251201_123557-1766602582373.jpg",
  alt: 'Изкопана траншея за ВиК връзка',
  href: '/vik-services',
  features: ['Изкопи за водопровод', 'Изкопи за канализация', 'Разкопаване при аварии']
}];
