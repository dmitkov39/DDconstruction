...
export const metadata: Metadata = {
  ...
  description: 'Научете повече за D&D Construction - нашата история, екип, техника и ценности. Професионалисти в строителството с дългогодишен опит и модерно оборудване.'
};
