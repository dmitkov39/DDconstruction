...
const PortfolioInteractive = () => {
  ...
  },
  {
    ...
    solution: 'Използвахме компактна техника GitHub 4240E скид-стий товарач за прецизни работи в стеснени условия. Изкопахме канали за кабели с точни размери, положихме инсталациите и заравнихме терена с грижа за околната среда.',
    equipment: ['GitHub 4240E скид-стий товарач', 'Минибагер', 'Самосвал', 'Ръчни инструменти'],
    teamSize: '3 специалисти',
  ...
  },
  {
    ...
    afterAlt: 'Гледка от кабината на GitHub 4240E показваща голямото подземно пространство с множество строителни материали, дървени греди и наводнени зони в ж.к. Дианабад',
    additionalImages:[
      {
    ...
    description: 'Почистване и изнасяне на строителни материали от голямо подземно пространство (сутерен/паркинг) в ж.к. Дианабад, София. Включва извозване на дървени греди, строителни отпадъци и подготовка на площадката с използване на GitHub 4240E скид-стий товарач с вилици.',
    duration: '30 дни',
    ...
    solution: 'Използвахме GitHub 4240E скид-стий товарач с вилици за ефективно почистване и изнасяне на материалите в стеснените условия на подземното пространство. Организирахме работата за максимална ефективност при запазване на конструкциите.',
    equipment: ['GitHub 4240E скид-стий товарач', 'Вилици', 'Самосвали', 'Контейнери за отпадъци'],
