...
const PortfolioInteractive = () => {
  ...
  },
  {
    ...
    afterAlt: 'Гледка от кабината на Gehl 4240E показваща голямото подземно пространство с множество строителни материали, дървени греди и наводнени зони в ж.к. Дианабад',
    additionalImages:[
      {
        image: "/assets/images/20251218_095050-1766603027797.jpg",
        alt: 'Gehl 4240E с вилици в подземното пространство с наводнена част от пода и строителни материали в ж.к. Дианабад'
      }
    ],
    description: 'Почистване и изнасяне на строителни материали от голямо подземно пространство (сутерен/паркинг) в ж.к. Дианабад, София. Включва извозване на дървени греди, строителни отпадъци и подготовка на площадката с използване на Gehl 4240E скид-стий товарач с вилици.',
    duration: '30 дни',
    location: 'ж.к. Дианабад, София',
    completionDate: '01.12.2025',
    challenge: 'Работа в голямо подземно пространство с бетонни колони и греди изискваше компактна техника и прецизна логистика за изнасяне на големи количества строителни материали.',
    solution: 'Използвахме Gehl 4240E скид-стий товарач с вилици за ефективно почистване и изнасяне на материалите в стеснените условия на подземното пространство. Организирахме работата за максимална ефективност при запазване на конструкциите.',
    equipment: ['Gehl 4240E скид-стий товарач', 'Вилици', 'Самосвали', 'Контейнери за отпадъци'],
    teamSize: '4 специалисти',
    clientTestimonial: 'Отлична работа в трудни условия! Подземното пространство беше почистено професионално и в срок. Екипът работи внимателно около колоните и конструкциите.'
  },
    {
    id: 6,
    ...
    additionalImages:[
      {
        image: "/assets/images/Dani_Ihtiman3.jpg",
        alt: 'Takeuchi TB016 в заден план копае под стълбище'
      }
    ],
    description: 'Изкоп около къща в град Ихтиман за поставяне на хидроизолация и ВиК. Използван бе минибагер Takeuchi TB016.',
    duration: '1 ден',
    location: 'град Ихтиман, Област София',
    completionDate: '17.02.2026',
    challenge: 'Съществото на работата се състоеше от правилното пускане на нивата за канализационната система, като основна трудност беше тясното пространство.',
    solution: 'Използвахме Тakeuchi TB016 мини багер с кофа 20см, и 40см. Организирахме работата така, че да получим максимална ефективност при запазване на конструкциите.',
    equipment: ['takeuchi TB016', 'кофа 20см.', 'кофа 40см.'],
    teamSize: '2 специалисти',
    clientTestimonial: 'Нивата за канализация бяха направени перфектно, Изкопът за хидроизолацията беше направен без никакви нарушемния на целостта на къщата.'
  },
    {
      id: 7,
    ...
    additionalImages:[
      {
        image: "/assets/images/Beton 1.jpg",
        alt: 'Takeuchi TB016 Вдигнат с кран'
      },
      {
         image: "/assets/images/Beton 3.jpg",
        alt: 'POV от кабината на Takeuchi TB016'
      }
    ],
    description: 'Премахване на излишен бетон около жилиюна сграда. Използван бе минибагер Takeuchi TB016.',
    duration: ' в ход на изпълнение',
    location: 'град София, ж.к Дианабад',
    StartedDate: '17.02.2026',
    challenge: 'Съществото на работата се състои от премахването на излизшно налетият бетон, трудност представляваше ограниченият достъп и товаримостта на плпочата.',
    solution: 'Използвахме Тakeuchi TB016 мини багер с кофа 20см, 40см и хидравличен чук. Организирахме работата така, че да получим максимална ефективност при запазване на конструкциите.',
    equipment: ['takeuchi TB016', 'кофа 20см.', 'кофа 40см.'],
    teamSize: '2 специалисти',
    }
  ];
