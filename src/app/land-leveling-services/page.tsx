...
export const metadata: Metadata = {
  ...
  description:
    'Професионално заравняване на терени с фокус върху дренаж и стабилност. Прецизна подготовка на площи с модерна техника и доказани методи за перфектно изравнени терени.',
  keywords: [
